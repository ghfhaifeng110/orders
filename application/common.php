 ...
 * @return string
 */
function weidan_hash($password)
{
    return md5(md5($password) . 'weidan_salt_SmTRx');
}
 ...
 * @param string $type
 */
function log_write($value, $type = 'weidan-info')
{
...
function get_version()
{
    ...
    $file =  WEB_PATH . '/version.json';
    if (!file_exists($file)) {
        throw new Exception('version.json not found'.$file);
    }
