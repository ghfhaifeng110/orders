                                            ...
                                            <div class="diy-goods" :style="{background:item.style.background}">
                                                <ul class="goods-list am-cf"
                                                    ...
                                                    <li class="goods-item"
                                                        ...
                                                        <div class="detail">
                                                            <p class="goods-name"
                                                               :class="item.style.column > 1 ? 'twolist-hidden' : ''"
                                                               v-if="item.style.show.goodsName">
                                                                {{goods.goods_name}}
                                                            </p>
                                                            <p class="selling-point"
                                                               v-if="item.style.show.sellingPoint && item.style.column == 1">
                                                                {{ goods.selling_point }}
                                                            </p>
                            ...
                            <form class="am-form tpl-form-line-form">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-8 am-u-end">
                                        <label class="am-radio-inline">
                                            <input type="radio" value="1"
                                                   v-model="curItem.style.column"> 单列
                                        </label>
                                        <label class="am-radio-inline">
                                            <input type="radio" value="2"
